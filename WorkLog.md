...
- 尝试了不加超前角补偿，电机转动异常，设定好location之后，电机来回高频摆动，并不能走到目标location。超前角补偿计算函数里面写了参数是别的ic测出来的，mt6816不一定适用，但是不加这个计算电机就无法正常运行。好奇怪
...
- 分析：抓取了实时速度，发现基本上1600000step/s基本上是能达到的最大值，也就是差不多30r/s应该是最大值，不然就会跟不上速度追踪器理论值，导致提早开始减速。
